...
import pt.iade.getmatch.dto.request.AuthRequest;
...
public class AuthController {
    ...
    public ResponseEntity<?> signIn(@RequestBody AuthRequest userRequest) {
        ...
        userAuthResponse.setId(user.get().getId());
        userAuthResponse.setNome(user.get().getName());
        userAuthResponse.setTelefone(user.get().getTelefone());
        userAuthResponse.setEmail(user.get().getEmail());
        userAuthResponse.setDataNascimento(user.get().getbDate());
